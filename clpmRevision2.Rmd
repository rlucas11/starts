...
As a result, the model incorporates an *accumulating* factor [@usami_differences_2020]. This term reflects the fact that influence of the stable trait accumulates over time: the stable trait affects observations at each wave directly and indirectly through all prior waves.   A detailed discussion of the dynamic panel model and its relation to the RI-CLPM is beyond the scope of this paper, but a number of recent papers have compared these models in detail, and readers are referred to them for further discussion. 

...
[^lag2]: It is important to note that these results reflect expectations from simple lag-1 cross-lagged models; more complex versions of this model can account for the slow decline in stability coefficients shown in Panel C. For instance, adding additional lagged effects from earlier waves or adding time-invariant covariates can help satisfy the assumptions underlying the causal interpretation of the cross-lagged paths [@murayama_thinking_2022; @ludtke_comparison_2022]. However, many implementations of the CLPM fail to include such features, and in these cases, this critical assumption is likely violated. 

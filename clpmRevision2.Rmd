...
## Between-Person and Within-Person Effects: Ambiguous Terminology
...
In summary, many---if not most---psychological constructs will have patterns of stability that are consistent with the existence of some form of stable, person-level influences. When such influences exist, a critical assumption of the CLPM will be violated. In such cases, the lagged associations in a simple lag-1 CLPM cannot be interpreted as a causal effect. Considering the multilevel structure of the data and applying appropriate multilevel models [as reflected in the RI-CLPM, @hamaker_critique_2015] is one way to address this issue. Alternatively, models that account for these unmeasured person-level factors through other means can address this issue in different ways [for instance, in dynamic panel models, @dishop_tutorial_2021]. 

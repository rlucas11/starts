...
[^caveat]: Ultimately, I think that Hamaker et al.'s [-@hamaker_critique_2015] framing is a more precise way of saying the same thing; my point is that we don't necessarily need to the within/between framing to understand the problems with the CLPM. 
...
```{r simFig, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='Simulation results for two-wave CLPM. Columns reflect different reliabilities. Rows reflect different ratios of autoregressive to stabler-trait variance. Lines reflect different correlations between stable-trait components.', out.height="90%"}
knitr::include_graphics("images/2WaveSimulation.png")
```
...
```{r simFig10, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='Simulation results for ten-wave CLPM. Columns reflect different reliabilities. Rows reflect different ratios of autoregressive to stabler-trait variance. Lines reflect different correlations between stable-trait components.', out.height="90%"}
knitr::include_graphics("images/10WaveSimulation.png")
```
